...
public:
	...
	void Draw(D3DXMATRIX vista, D3DXMATRIX proyeccion, D3DXVECTOR3 poscam, float xx, float zz, float posy, float escalaX, float escalaY, vector2* uv1, vector2* uv2, vector2* uv3, vector2* uv4, int frame)
	{
		posx = xx;
		posz = zz;
		vertices = new VertexComponent[4];
