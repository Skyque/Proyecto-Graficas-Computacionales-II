...
private:
	...
	ID3D11ShaderResourceView* textura, *textura2;
...
public:
	...
	void Render(D3DXVECTOR3 trans)
	{
		...
		D3DXMATRIX worldMat, auxMatrix;
		D3DXMatrixRotationY(&worldMat, -rotation * .008f);

		D3DXMatrixTranslation(&auxMatrix, trans.x, trans.y - 50.0f, trans.z);

		D3DXMatrixMultiply(&worldMat, &worldMat, &auxMatrix);
		...
		(*d3dContext)->PSSetConstantBuffers(1, 1, &FactorCB);
